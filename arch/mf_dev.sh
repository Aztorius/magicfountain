...
echo '# ************************************************************************** #'
echo '# https://github.com/Aztorius/magicfountain/tree/dev                         #'
echo '##############################################################################'
sleep 2s
read -rsp $'Delete old Magic Fontain BETA build [$HOME/magicfountain-dev]. Press any key or wait 5 seconds to continue...\n' -n 1 -t 5;
rm -rf magicfountain-dev
...
echo 'Create Working Folder [./magicfountain-dev]'
mkdir magicfountain-dev && pushd magicfountain-dev
echo 'Download [Aztorius/magicfountain/archive/dev.zip] . . . . .'
tput sgr0
wget --verbose --referer=https://github.com/ -t 20 --no-check-certificate https://github.com/Aztorius/magicfountain/archive/dev.zip
tput setaf 2
...
sleep 2s
magicfountain-dev/magicfountain-dev/magicfountain
